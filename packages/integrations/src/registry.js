export class IntegrationRegistry {
    ...
    searchIntegrations(query) {
        ...
        return this.getAllIntegrations().filter(integration => integration.name.toLowerCase().includes(searchTerm) ||
    ...
    getAppsDataSources() {
        return [
            ...
            },
            {
                ...
                triggers: ['sync_trigger', 'event_trigger', 'action'],
            ...
            // Storage & Cloud (12 integrations)
            {
                ...
                triggers: ['sync_trigger', 'event_trigger'],
        ...
        return [
            {
                ...
                models: [
                    ...
                    },
                    {
                        ...
                        inputPricing: 0.01,
                        outputPricing: 0.03,
                        features: ['function_calling', 'vision', 'structured_output'],
                    ...
                    },
                    {
                        ...
                        inputPricing: 0.0015,
                        outputPricing: 0.002,
                        features: ['function_calling', 'fast_inference'],
